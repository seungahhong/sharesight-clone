...
export default function CompanySelector({ onSelect, selectedCodes }: CompanySelectorProps) {
    ...
    return (
        <div className="relative" ref={wrapperRef}>
            ...
            {isOpen && (
                <div className="absolute top-full left-0 mt-2 w-80 bg-white rounded-lg shadow-xl border border-gray-200 z-50 max-h-96 flex flex-col">
                                    ...
                                    return (
                                        ...
                                        >
                                            <div>
                                                ...
                                                <div className="text-xs text-gray-500">{stock.srtnCd} | {stock.mrktCtg}</div>
                                            </div>
                                            {isSelected && <span className="text-xs text-teal-600 font-medium">선택됨</span>}
                                        </button>
                                    )
                                })}
                            </div>
